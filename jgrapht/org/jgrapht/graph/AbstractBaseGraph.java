 ...
 *                   Christian Hammer
 *
 * $Id: AbstractBaseGraph.java,v 1.1 2009/10/22 15:09:54 charlesz Exp $
 *
 * Changes
 * -------
        ...
        Serializable
{
    ...
    public E addEdge_edgetype_lpxz(V sourceVertex, V targetVertex, Class clazz)
    {
        assertVertexExist(sourceVertex);
        assertVertexExist(targetVertex);
        ...
        E edge =null;// create edge, specialized
        try {
        	edge= (E) clazz.newInstance();
        } catch (Exception ex) {
        ...
        if (containsEdge(edge)) { // this restriction should stay!
